...
if (is_array($lista)) {
  foreach ($lista as $reg) {
    ...
    ?>
    <th><img src="../img/imgProd/<?php echo $reg[6];?>"
     width="260" height="260" alt="">
     <br><br>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="enviar(<?php echo $reg[0];?>)" >Ver</button>
    </th>
